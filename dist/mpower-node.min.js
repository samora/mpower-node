...
function CheckoutInvoice(e,t){Invoice.call(this,e,t),this.baseURL=this.baseURL+"/checkout-invoice"}var Invoice=require("./invoice"),request=require("superagent"),Promise=require("bluebird");CheckoutInvoice.prototype=Object.create(Invoice.prototype),CheckoutInvoice.prototype.constructor=CheckoutInvoice,CheckoutInvoice.prototype.create=function(){var e=this,t=e.generateRequestBody();return new Promise(function(o,n){request.post(e.baseURL+"/create").set(e.config).send(t).end(function(t,r){if(t)return n(t);if("00"===r.body.response_code)e.token=r.body.token,e.url=r.body.response_text,o(e.confirm());else{var c=new Error("Failed to create invoice.");c.data=r.body,n(c)}})})},CheckoutInvoice.prototype.confirm=function(e){var t=this,o=e?e:t.token;return new Promise(function(e,n){request.get(t.baseURL+"/confirm/"+o).set(t.config).end(function(o,r){if(o)return n(o);var c=r.body;if("00"===c.response_code)t.status=c.status,t.responseText=c.response_text,"completed"===t.status&&(t.customer=c.customer,t.receiptURL=c.receipt_url,c.invoice.custom_data&&Object.keys(c.invoice.custom_data).length>0&&(t.customData=c.invoice.custom_data)),t.totalAmount=c.invoice.total_amount,e();else{var i=new Error("Could not confirm invoice status.");i.data=c,n(i)}})})},module.exports=CheckoutInvoice;

},{"./invoice":4,"bluebird":6,"superagent":11}],2:[function(require,module,exports){
function DirectPay(e){if(!e||!e.config)throw new Error("Must be initialized with instance of mpower.Setup");this.config=e.config,this.baseURL=e.baseURL+"/direct-pay"}var request=require("superagent"),Promise=require("bluebird"),util=require("util");DirectPay.prototype.creditAccount=function(e,r){var t=this,i={account_alias:e,amount:Number(r)};return new Promise(function(o,n){request.post(t.baseURL+"/credit-account").set(t.config).send(i).end(function(i,a){if(i)return n(i);if("00"===a.body.response_code)t.responseText=a.body.response_text,t.description=a.body.description,t.transactionID=a.body.transaction_id,o();else{var c=new Error(new Error(util.format("Failed to credit account. Please ensure %s and %s are valid OR check your account balance.",e,r)));c.data=a.body,n(c)}})})},module.exports=DirectPay;

},{"bluebird":6,"superagent":11,"util":10}],3:[function(require,module,exports){
(function (process){
function Setup(e){this.config={},this.config["MP-Master-Key"]=e&&e.masterKey||process.env.MP_MASTER_KEY,this.config["MP-Private-Key"]=e&&e.privateKey||process.env.MP_PRIVATE_KEY,this.config["MP-Token"]=e&&e.token||process.env.MP_TOKEN,this.config["Content-Type"]="application/json",e&&e.mode&&"test"===e.mode.toLowerCase()?this.baseURL="https://app.mpowerpayments.com/sandbox-api/v1":this.baseURL="https://app.mpowerpayments.com/api/v1"}function Store(e){if(!e||!e.name)throw new Error("Invalid parameters.");this.name=e.name,e.tagline&&(this.tagline=e.tagline),e.phoneNumber&&(this.phone_number=e.phoneNumber),e.postalAddress&&(this.postal_address=e.postalAddress),e.logoURL&&(this.logo_url=e.logoURL),e.websiteURL&&(this.website_url=e.websiteURL),e.cancelURL&&(this.cancel_url=e.cancelURL),e.returnURL&&(this.return_url=e.returnURL)}exports.Setup=exports.setup=Setup,exports.Store=exports.store=Store,exports.CheckoutInvoice=exports.checkoutInvoice=require("./checkout-invoice"),exports.OnsiteInvoice=exports.onsiteInvoice=require("./onsite-invoice"),exports.DirectPay=exports.directPay=require("./direct-pay");
}).call(this,require('_process'))
},{"./checkout-invoice":1,"./direct-pay":2,"./onsite-invoice":5,"_process":8}],4:[function(require,module,exports){
function Invoice(t,e){if(!(t&&e&&t.config["MP-Master-Key"]&&t.config["MP-Private-Key"]&&t.config["MP-Token"]&&e.name))throw new Error("Invalid parameters;");this.baseURL=t.baseURL,this.config=t.config,e.return_url&&(this.returnURL=e.return_url),e.cancel_url&&(this.cancelURL=e.cancel_url),this.store=e,this.description="",this.items={},this.customData={},this.taxes={},this.totalAmount=0}Invoice.prototype.addItem=function(t,e,i,s,n){if(!t)throw new Error("Invalid parameters; name is required.");var o=Object.keys(this.items).length+1;this.items["item_"+o]={name:t,quantity:e||0,unit_price:i||0,total_price:s||0},n&&(this.items["item_"+o].description=n)},Invoice.prototype.addTax=function(t,e){if(!t||"string"!=typeof t||"number"!=typeof Number(e))throw new Error("Invalid parameters.");var i=Object.keys(this.taxes).length+1;this.taxes["tax_"+i]={name:t,amount:Number(e)}},Invoice.prototype.addCustomData=function(t,e){if(!t||!e)throw new Error("Invalid parameters.");this.customData[t]=e},Invoice.prototype.generateRequestBody=function(){if(!(this.store&&this.store.name&&this.baseURL&&this.totalAmount>0))throw new Error("Invalid parameters. Initialize Invoice with valid instances of Setup and Store. Total amount must also be set.\neg: var invoice = new Invoice; invoice.init(setup, store); invoice.setTotalAmount(40)");var t={invoice:{total_amount:this.totalAmount},store:this.store};return this.description&&(t.invoice.description=this.description),Object.keys(this.items).length>0&&(t.invoice.items=this.items),(this.returnURL||this.cancelURL)&&(t.actions={},this.returnURL&&(t.actions.return_url=this.returnURL),this.cancelURL&&(t.actions.cancel_url=this.cancelURL)),Object.keys(this.taxes).length>0&&(t.invoice.taxes=this.taxes),Object.keys(this.customData).length>0&&(t.custom_data=this.customData),t},module.exports=Invoice;
